...
public class AltaProfesor extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-- Escoge una materia --", "Administración", "Ciencias", "Educación Físcica", "Idiomas", "Informática", "Finanzas", "Marketing", " " }));
        ...
        jLabel6.setText("Relacion Laboral");

        buttonGroup1.add(jRadioButton1);
        jRadioButton1.setText("Autónomo");
...
dispose ();   
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (p.getNif().isEmpty() || p.getNombre().isEmpty() || p.getApellidos().isEmpty()){        
            ...
            JOptionPane.showMessageDialog(this, "Debes escoger una especialdidad", "Especialidad Vacia", JOptionPane.ERROR_MESSAGE);       
        }else if (!jRadioButton1.isSelected() && !jRadioButton2.isSelected()){
        JOptionPane.showMessageDialog(this, "Debes escoger una opción", "Relación Laboral", JOptionPane.ERROR_MESSAGE);               
